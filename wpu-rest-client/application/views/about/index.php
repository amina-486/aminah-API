            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDIO 3 - JSON/latihan1.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDIO 4 - HUT/latihan2.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDIO 5 - MOVIE/index.html" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>   
          </div>
            ...
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDIO 6 - PORTOFOLIO/index.php" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div> 
            <div class="col-md mb-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= base_url(); ?>../VIDIO7/" class="card-link see-detail"data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="`+ data.imdbID +`" >See Project</a>
                </div>
              </div>
            </div>
